...
def maskobfpdf(json_data):
    filepath=os.path.dirname(os.path.abspath(_file_))+"\\"+json_data['fileName']
    modified_dict = {}
    ...
    modified_pdf_path = os.path.join(os.path.dirname(os.path.abspath(_file)), "modified" + os.path.basename(filepath))
