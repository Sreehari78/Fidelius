    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      <header className="container mx-auto px-4 py-8 flex justify-between items-center">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-2xl font-bold text-gray-800">FileMask</span>
        </div>
        <nav>
      ...
      <main>
        <section className="container mx-auto px-4 py-20 text-center">
          <h1 className="text-5xl font-bold text-gray-900 mb-6">Secure Your Sensitive Data with FileMask</h1>
          <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
            Easily mask and obfuscate your files to protect confidential information. 
            Keep your data safe without compromising its usability.
          </p>
          <Link 
            href="/next" 
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-blue-50 p-6 rounded-lg">
                ...
                <p className="text-gray-600">Protect your files with state-of-the-art encryption algorithms.</p>
              </div>
              <div className="bg-blue-50 p-6 rounded-lg">
                <FileText className="w-12 h-12 text-blue-600 mb-4" />
                <h3 className="text-xl font-semibold mb-2">Multiple File Formats</h3>
                <p className="text-gray-600">Support for various file types including documents, spreadsheets, and more.</p>
              </div>
              <div className="bg-blue-50 p-6 rounded-lg">
                <Shield className="w-12 h-12 text-blue-600 mb-4" />
                <h3 className="text-xl font-semibold mb-2">Customizable Masking</h3>
                <p className="text-gray-600">Tailor the level of obfuscation to meet your specific needs.</p>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-3xl mx-auto">
              <ol className="relative border-l border-gray-200">
                <li className="mb-10 ml-6">
                  ...
                  <p className="text-gray-600">Securely upload the file you want to mask or obfuscate.</p>
                </li>
                <li className="mb-10 ml-6">
                  <span className="absolute flex items-center justify-center w-8 h-8 bg-blue-100 rounded-full -left-4 ring-4 ring-white">
                    2
                  </span>
                  <h3 className="font-semibold text-lg mb-1">Choose Masking Options</h3>
                  <p className="text-gray-600">Select the level of masking and specific areas to obfuscate.</p>
                </li>
                <li className="mb-10 ml-6">
                  <span className="absolute flex items-center justify-center w-8 h-8 bg-blue-100 rounded-full -left-4 ring-4 ring-white">
                    3
                  </span>
                  <h3 className="font-semibold text-lg mb-1">Process and Download</h3>
                  <p className="text-gray-600">Our system processes your file and provides a secure download link.</p>
                </li>
              </ol>
            </div>
          </div>
              ...
              <div className="px-6 py-8">
                ...
                <ul className="mb-6">
                  <li className="flex items-center mb-2">
                    ...
                    <span>Unlimited file masking</span>
                  </li>
                  <li className="flex items-center mb-2">
                    <CheckCircle className="w-5 h-5 text-green-500 mr-2" />
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              ...
              <p className="text-sm text-gray-400 mt-2">Secure your files with confidence</p>
            </div>
            <nav>
              <ul className="flex space-x-6">
