...
pdfjs.GlobalWorkerOptions.workerSrc =
  "http://192.168.56.1:3000/pdf.worker.min.mjs";

// You can change the path to your PDF file here
const pdfFilePath = "http://192.168.56.1:3000/modified_bank_form.pdf"; // Ensure this file is located in the public folder
