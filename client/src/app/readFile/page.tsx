  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (fileName.split(".").pop() === "csv") {
        ...
        response = await fetch("http://localhost:5000/maskobfpdf", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
      ...
      else if (result["output"] === "pdf") router.push("/outputPdf"); // Redirect to the /outputPdf page
    } catch (error) {
      console.error("Error:", error);
    ...
    <div className='container mx-auto p-4 max-w-4xl'>
      ...
      {backendColumns.length > 0 && (
        <div className='space-y-4'>
          <h2 className='text-xl font-semibold'>Detected PII</h2>
